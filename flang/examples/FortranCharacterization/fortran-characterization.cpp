...
std::unordered_map<const char *, bool> FeatureCharacterization::features{
    ...
    {"Overriding a type-bound procedure", false},
    {"Enumerations", false}, 
    {"ASSOCIATE construct", false},
    {"Polymorphic entities", false}, 
    {"SELECT TYPE construct", false},
    {"Deferred bindings and abstract types", false},
    {"Structure constructors", false},
    {"The allocate statement (allocate with SOURCE)", false},
    {"Allocatable scalars", false}, 
    {"Allocatable character length", false},
    ...
    {"Pointer INTENT", false},
    {"VOLATILE attribute", false},
    ...
    {"Complex constants", false},
    {"Changes to intrinsic functions", false},
    {"Controlling IEEE underflow", false},
    {"Another IEEE class value", false},
    {"Derived type I/O", false},
    {"Asynchronous I/O", false},
    {"FLUSH statement", false},
    {"IOMSG= spcifier", false},
    {"Stream access I/O", false},
    {"ROUND= spcifier", false},
    {"DECIMAL= spcifier", false},
    {"SIGN= spcifier", false},
    ...
    {"Bessel functions", false},
    {"Error and gamma functions", false},
    {"Euclidean vector norms", false},
    {"Parity", false},
    {"Execute command line", false},
    {"Optional back argument added to maxloc and minloc", false},
    {"Find location in an array", false},
    ...
    {"Null pointer or unallocated allocatable as an absent dummy argument", false},
